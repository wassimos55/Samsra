  ...
  <div class="container">
      <div class="row">
          ...
          <div class="col-lg-9">
                    ...
                    <div class="row md-5 ">
                      <div class="col-md-4 mb-4">
                        <div class="card shadow-xl">
                          <div class="card-body text-center bg-white border-radius-lg p-3">
                            <a href="javascript:;">
                              <img class="w-100 border-radius-md" src="assets/img/1.jpg" alt="card image">
                            </a>
                            <p class="m-2 text-xs font-weight-bolder text-info text-gradient text-uppercase">Desktop Publisher</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-4">
                        <div class="card shadow-xl">
                          <div class="card-body text-center bg-white border-radius-lg p-3">
                            <a href="javascript:;">
                              <img class="w-100 border-radius-md" src="assets/img/2.jpg" alt="card image">
                            </a>
                            <p class="m-2 text-xs font-weight-bolder text-info text-gradient text-uppercase">Desktop Publisher</p>
                          </div>
                        </div>
                      ...
                      <div class="col-md-4 mb-4">
                        <div class="card shadow-xl">
                          <div class="card-body text-center bg-white border-radius-lg p-3">
                            <a href="javascript:;">
                              <img class="w-100 border-radius-md" src="assets/img/3.jpg" alt="card image">
                            </a>
                            <p class="m-2 text-xs font-weight-bolder text-info text-gradient text-uppercase">Desktop Publisher</p>
                          </div>
                        </div>
                      ...
                      <div class="col-md-4 mb-4">
                        <div class="card shadow-xl">
                          <div class="card-body text-center bg-white border-radius-lg p-3">
                            <a href="javascript:;">
                              <img class="w-100 border-radius-md" src="assets/img/7.jpg" alt="card image">
                            </a>
                            <p class="m-2 text-xs font-weight-bolder text-info text-gradient text-uppercase">Desktop Publisher</p>
                          </div>
                        </div>
                      ...
                      <div class="col-md-4 mb-4">
                        <div class="card shadow-xl">
                          <div class="card-body text-center bg-white border-radius-lg p-3">
                            <a href="javascript:;">
                              <img class="w-100 border-radius-md" src="assets/img/8.jpg" alt="card image">
                            </a>
                            <p class="m-2 text-xs font-weight-bolder text-info text-gradient text-uppercase">Desktop Publisher</p>
                          </div>
                        </div>
                      ...
                      <div class="col-md-4 mb-4">
                        <div class="card shadow-xl">
                          <div class="card-body text-center bg-white border-radius-lg p-3">
                            <a href="javascript:;">
                              <img class="w-100 border-radius-md" src="assets/img/6.jpg" alt="card image">
                            </a>
                            <p class="m-2 text-xs font-weight-bolder text-info text-gradient text-uppercase">Desktop Publisher</p>
                          </div>
                        </div>
              ...
              <!--Templates End -->
              <!--pagination Start -->
                <div class="col-sm-7 ms-auto text-center">
