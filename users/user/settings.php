...
<nav
  ...
  <div class="container">
    <a class="navbar-brand" href="index.php" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="">
      Samsra TN
    </a>
    ...
    <div class="collapse navbar-collapse" id="navigation">
      ...
      <div class="avatar-group dropdown">
        <a href="javascript:;" id="navbarDropdownMenuLink2"  data-bs-toggle="dropdown" class="avatar avatar-lg rounded-circle dropdown-toggle"  data-bs-placement="bottom" title="Ryan Tompson">
          <img style="width: 40px;height: 40px;" alt="Image placeholder" src="https://iso.500px.com/wp-content/uploads/2015/01/50shades_17.jpg">
        </a>
    ...
    <div class="page-header min-vh-50" style="background-image: url('https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/minimal-interior.jpg')">
      ...
      <div class="container">
        <div class="row">
          ...
          <h2 class="text-white">L'appli qui vous facilite la vie.</h2>
            <p class="lead" style="font-size:0.9em">La base en ligne qui regroupe toutes les procédures administratives en Tunisie pour faciliter la vie .</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
      <div class="row">
          ...
          <div class="col-lg-3 mb-lg-0 mb-3 mt-7">
                ...
                <li class="nav-item">
                    <a  class="nav-link text-dark" data-scroll="" href="templates.php">
                        <div class="icon me-2">
                        <svg class="text-info" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <a  class="nav-link text-dark" data-scroll="" href="upload.php">
                        <div class="icon me-2">
                        <svg class="text-info" width="16px" height="16px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <a  class="nav-link text-dark" data-scroll="" href="enattent.php">
                        <div class="icon me-2">
                        <svg class="text-info" width="16px" height="16px" viewBox="0 0 42 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <a  class="nav-link text-dark" data-scroll="" href="portfolio.php">
                        <div class="icon me-2">
                        <svg class="text-info" width="16px" height="16px" viewBox="0 0 44 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <div class="card p-5 mt-7">
              ...
              <form class="row">
                      <h5 class="mb-2">Gérez vos informations, votre confidentialité et votre sécurité pour que <span class="text-gradient text-info">Samsra TN</span>  fonctionne mieux pour vous. </h5>
                      <br><br> <br> <br>
                  
                  
                  
                  <div class="form-group col-md-6">
                      <label for="exampleFormControlInput1">Téléchargez votre Photo ici </label>
                      <input type="file" class="form-control" >
                  </div>
                  <div class="form-group col-md-6">
                      <label for="exampleFormControlInput1">PIN  </label>
                      
                      <input type="text" class="form-control" placeholder="Update your PIN Number"  aria-describedby="button-addon2">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" placeholder="Update your first name"  aria-describedby="button-addon2">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" placeholder="Update your last name "  aria-describedby="button-addon2">

                  
                  </div> 
                  <div class="form-group col-md-6">
                          <label>Merci de choisir votre ville actuelle</label>
                  ...
                  <div class="form-group col-md-6">
                      <label for="exampleFormControlInput1">merci de saisir votre ancien mot de passe! </label>
                      
                      <input type="password" class="form-control" placeholder="Set your password"  aria-describedby="button-addon2">

                  
                  </div>
                  <div class="form-group col-md-6">
                      <label for="exampleFormControlInput1">merci de saisir votre nouveau mot de passe! </label>
                      
                      <input type="password" class="form-control" placeholder="Update your password"  aria-describedby="button-addon2">
              ...
              <div class="row">
                  <div class="col-md-6">
                    ...
                    <button type="button" class="btn bg-gradient-info btn-lg w-100">Enregistrer</button>
                  </div>
                  <div class="col-md-6 ps-md-2">
                  <button type="button" class="btn bg-gradient-info btn-lg w-100">Annuler </button>
                  </div>
              </div>
    ...
    <div class="container">
      <div class=" row">
        <div class="col-md-3 mb-4 ms-auto">
          <div>
            <h6 class="text-gradient text-info font-weight-bolder">Samesra</h6>
          </div>
          <div>
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="my-4 text-sm">
              ...
              </script> Samesra by <a href="" target="_blank">Spark X</a>.
            </p>
          </div>
        </div>
      </div>
