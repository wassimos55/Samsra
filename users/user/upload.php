  ...
  <div class="container">
      <div class="row">
          ...
          <div class="card p-5 mt-7">
              <form>
                      <h3 class="mb-2">Merci de choisir une fichier</h3>
                      
                  <div class="form-group">
                      <label for="exampleFormControlInput1">Téléchargez votre fichier ici </label>
                      <input type="file" class="form-control" >
                  </div>
                  <div class="form-group">
                      <label for="exampleFormControlInput1">Merci de saisir votre code pin ! </label>
                      
                      <input type="text" class="form-control" placeholder="PIN Number"  aria-describedby="button-addon2">
                      <button type="button" class="btn btn-outline-info btn-lg w-100 mt-4">Merci de saisir votre signature</button>
              ...
              <div class="row">
                  ...
                  <a href="collabor.php" type="button" class="btn bg-gradient-info btn-lg w-100">Ajouter un collaborateur </a>
                  </div>
              </div>
          </div>
         <!--Form End -->
